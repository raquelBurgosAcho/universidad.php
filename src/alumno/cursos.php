                                        ...
                                        if ($result) {
                                            ...
                                            if ($result->num_rows > 0) {
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    echo "<td class='px-2 py-2 border-[1px] border-gray-200'> <a href='darse_baja.php?id=" . $row['id'] . "'><span class='material-symbols-outlined text-red-400'>cancel_presentation</span></a></td>";
                                                    echo "</tr>";
                                                }
                                            } else {
                                ...
                                <div class="flex items-center border-gray-300 border-2 pr-3 rounded-md  hover:bg-slate-200  hover:shadow-custom hover:shadow-zinc-800">
                                    <table class="w-full">
                                        <tbody>
                                            ...
                                            $query = "SELECT cursos.id, cursos.nombre_curso
                                            FROM cursos
                                            LEFT JOIN inscripciones ON cursos.id = inscripciones.cursoID AND inscripciones.estudianteID = $id
                                            ...
                                            if ($result) {
                                                ...
                                                if ($result->num_rows > 0){
                                                    while ($row = $result->fetch_assoc()) {
                                                        ...
                                                        echo "<tr>";
                                                        echo "<td class='px-2 py-2 border-[1px] border-gray-200'>" . $row['nombre_curso'] . "</td>";
                                                        echo "<td class='px-2 py-2 border-[1px] border-gray-200'> <a href='inscribir_curso.php?id=" . $row['id'] . "'><span class='material-symbols-outlined text-green-400'>add</span></a></td>";
                                                        echo "</tr>";
                                                    }
                                                    echo '</table>';
                                                } else {

...
if (!isset($_SESSION['email'])) {
    ...
    require_once "../config/conexiondatabs.php";
...
WHERE maestroID = '$id_maestro'");
    ...
    $query = "SELECT estudiantes.nombre, estudiantes.id_estudiante
          FROM estudiantes
    ...
    <body>
        <main class="flex">
            ...
            <section id="menu2" class="w-[100%] h-[100vh] bg-[#f5f6fa] ">
                <nav id="nav"
                    class=" bg-white w-[100%] h-[9%] flex justify-between items-center gap-3 px-3 shadow-sm shadow-gray-400 fixed">
                    <div class="flex gap-3">
                        <span id="menu-icon"
                            class="material-symbols-outlined text-[#b6beb3] text-lg cursor-pointer hover:text-gray-600">menu</span>
                ...
                <div class="p-5 h-[80%] flex flex-col gap-6 mt-[70px] ">
                    <div class="flex justify-between">
                        <h1 class=" text-2xl font-medium text-gray-700">Alumnos de la Clase de
                            <?php echo $resultado2['nombre_curso'] ?></h1>
                        <div class="flex gap-1">
                    ...
                    <div
                        class="bg-white shadow-sm shadow-gray-400 w-[100%] rounded-sm  flex flex-col justify-center gap-1">
                                    ...
                                    <tr class="bg-white">
                                        <th scope="col" class="px-2 py-2 border-2 border-gray-300">
                                            <div class="flex justify-between">
                                                #
                                                <span
                                                    class="material-symbols-outlined text-gray-400 text-base">swap_vert</span>
                                            </div>
                                        </th>
                                        <th scope="col" class="px-2 py-2 border-2 border-gray-300">
                                ...
                                <tbody>
                                    <?php
                                        while ($row = $result->fetch_assoc()) {
                                            echo "<tr>";
                                            echo "<td class='px-2 py-2 border-[1px] border-gray-200'>" . $row['id_estudiante'] . "</td>";
                                            echo "<td class='px-2 py-2 border-[1px] border-gray-200'>" . $row['nombre'] . "</td>";
                        ...
                        <div class="w-[100%] flex items-center justify-between gap-1 p-2 pt-4 px-6 pb-6">
                            ...
                            <div class="flex">
                                <button
                                    class="hover:bg-slate-200 px-3 py-1 border-[1px] border-gray-500 rounded-l-lg">Previous</button>
                                <button
                                    class="hover:bg-blue-500 hover:text-white text-blue-600 px-3 py-1 border-y-[1px] border-gray-500">1</button>
                                <button
                                    class="hover:bg-slate-200 text-blue-600 px-3 py-1 border-[1px] border-gray-500 rounded-r-lg">Next</button>
                            </div>
                        </div>
                    </div>
